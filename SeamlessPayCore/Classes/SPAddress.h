...
+ (nullable NSDictionary *)shippingInfoForChargeWithAddress:(nullable SPAddress *)address
...
- (BOOL)containsRequiredShippingAddressFields:(nullable NSSet<SPContactField> *)requiredFields;


- (BOOL)containsContentForShippingAddressFields:(nullable NSSet<SPContactField> *)desiredFields;
