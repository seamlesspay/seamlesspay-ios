...
- (void)viewDidLoad {
  ...
  UIStackView *stackView = [[UIStackView alloc] initWithArrangedSubviews:@[logoImageView,
                                                                           amountLabel,
                                                                           descriptionLabel,
                                                                           cardTextField,
                                                                           button]];
...
- (void)pay {
  ...
  self.paymentAmount = [[self.amountTextField.text substringFromIndex:1] stringByReplacingOccurrencesOfString:@","
                                                                                                   withString:@""];
