...
+ (void)initialize {
    ...
    if (@available(iOS 13.0, *)) {
        SPThemeDefaultPrimaryBackgroundColor = [UIColor secondarySystemBackgroundColor];
...
#endif
        SPThemeDefaultPrimaryBackgroundColor = [UIColor colorWithRed:242.0f/255.0f green:242.0f/255.0f blue:245.0f/255.0f alpha:1];
        SPThemeDefaultSecondaryBackgroundColor = [UIColor whiteColor];
        SPThemeDefaultPrimaryForegroundColor = [UIColor colorWithRed:43.0f/255.0f green:43.0f/255.0f blue:45.0f/255.0f alpha:1];
        SPThemeDefaultSecondaryForegroundColor = [UIColor colorWithRed:142.0f/255.0f green:142.0f/255.0f blue:147.0f/255.0f alpha:1];
        SPThemeDefaultAccentColor = [UIColor colorWithRed:0 green:122.0f/255.0f blue:1 alpha:1];
        SPThemeDefaultErrorColor = [UIColor colorWithRed:1 green:72.0f/255.0f blue:68.0f/255.0f alpha:1];
#ifdef __IPHONE_13_0
    }
#endif
    SPThemeDefaultFont = [UIFont systemFontOfSize:17];

    SPThemeDefaultMediumFont = [UIFont systemFontOfSize:17.0f weight:0.2f] ?: [UIFont boldSystemFontOfSize:17];
}
