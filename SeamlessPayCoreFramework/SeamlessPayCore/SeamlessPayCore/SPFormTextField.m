...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (self.autoformattingBehavior == SPFormTextFieldAutoFormattingBehaviorNone && self.selectionEnabled) {
...
typedef NSAttributedString* (^SPFormTextTransformationBlock)(NSAttributedString *inputText);
    ...
    switch (autoFormattingBehavior) {
        ...
        case SPFormTextFieldAutoFormattingBehaviorCardNumbers:
            self.textFormattingBlock = ^NSAttributedString *(NSAttributedString *inputString) {
                ...
                SPCardBrand currentBrand = [SPCardValidator brandForNumber:attributedString.string];
        ...
        case SPFormTextFieldAutoFormattingBehaviorPhoneNumbers: {
            ...
            self.textFormattingBlock = ^NSAttributedString *(NSAttributedString *inputString) {
                ...
                NSString *phoneNumber = [SPPhoneNumberValidator formattedSanitizedPhoneNumberForString:inputString.string];
...
- (void)setDelegate:(id <UITextFieldDelegate>)delegate {
    SPTextFieldDelegateProxy *delegateProxy = [[SPTextFieldDelegateProxy alloc] init];
