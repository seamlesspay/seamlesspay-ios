...
//@class SPPaymentMethodThreeDSecureUsage, SPPaymentMethodCardChecks, SPPaymentMethodCardWallet;
...
/**
 You cannot directly instantiate an `SPPaymentMethodCard`. You should only use one that is part of an existing `SPPaymentMethod` object.
 */
- (instancetype)init __attribute__((unavailable("You cannot directly instantiate an SPPaymentMethodCard. You should only use one that is part of an existing SPPaymentMethod object.")));
 ...
 */
//@property (nonatomic, nullable, readonly) SPPaymentMethodThreeDSecureUsage *threeDSecureUsage;
